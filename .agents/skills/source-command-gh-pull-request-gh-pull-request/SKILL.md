---
name: "source-command-gh-pull-request-gh-pull-request"
description: "Create a Github pull request & commit changes"
---

# source-command-gh-pull-request-gh-pull-request

Use this skill when the user asks to run the migrated source command `gh-pull-request-gh-pull-request`.
