---
name: "source-command-add-to-changelog-add-to-changelog"
description: "Add a new entry to the project's CHANGELOG.md file"
---

# source-command-add-to-changelog-add-to-changelog

Use this skill when the user asks to run the migrated source command `add-to-changelog-add-to-changelog`.
