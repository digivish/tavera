---
name: "source-command-validate-validate"
description: "Validate the repository is in a working state"
---

# source-command-validate-validate

Use this skill when the user asks to run the migrated source command `validate-validate`.
