---
name: "source-command-clean-memory-clean-memory"
description: "Clean and organize project memory"
---

# source-command-clean-memory-clean-memory

Use this skill when the user asks to run the migrated source command `clean-memory-clean-memory`.

## Command Template

# How to clean and organize project memory
...
1. **Get Overview**
   - List all AGENTS.md and Codex.local.md files in the project hierarchy
...
This command is based on the work of Thomas Landgraf: https://thomaslandgraf.substack.com/p/Codex-codes-memory-working-with
