---
name: "source-command-docs-document-architecture"
description: "Create comprehensive architecture documentation"
---

# source-command-docs-document-architecture

Use this skill when the user asks to run the migrated source command `docs-document-architecture`.
